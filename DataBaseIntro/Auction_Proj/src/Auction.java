...
public class Auction {
	...
	private static boolean LoginMenu() {
		...
		try {
			...
			if (!rs.next()) {
				...
				if (isAdmin) {
					System.out.println("Want to login as Admin ID? (y/n) \n");
					asAdmin = scanner.next();
				}
				if (asAdmin.equalsIgnoreCase("y")) {
					System.out.println("Please use Admin loggin Option. \n");
					return false;
				}
	...
	private static boolean AdminMenu() {
		...
		try {
			...
			if (!rs.next()) {
				/* If Login Fails */
				System.out.println("\n Error: Incorrect Admin ID or password. Going back to the previous menu..\n\n");
				return false;
			} else {
				if (rs.getBoolean("is_admin")) {
					System.out.println("Successfully logged in as Admin ID.\n\n");
					System.out.println("==============Welcome===============\n");

				} else {
					/* If not a Admin ID */
					System.out.println("\n Error: Unauthorized ID. Going back to the previous menu.\n\n");
					return false;
				}
			}
		} catch (Exception e) {
	...
	public static void main(String[] args) {
		...
		} while (username == null || username.equalsIgnoreCase("back") || !ret);
